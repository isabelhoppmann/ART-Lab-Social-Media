...
You have all the needed values from previous steps. Collect them now:
- `DATE` — today's date string (YYYY-MM-DD), same as used in Steps 3–6
- Meme 1: `MEME_1_OVERLAY_TEXT`, `MEME_1_IG_CAPTION`, `MEME_1_FB_CAPTION`, `MEME_1_HASHTAGS`, `MEME_1_GIF_URL` (direct .gif URL), `MEME_1_GIPHY_EMBED_ID` (Giphy ID for iframe)
- Meme 2: same fields with `MEME_2_` prefix
- Repost 1: `REPOST_1_URL`, `REPOST_1_CREATOR`, `REPOST_1_CAPTION`
- Repost 2: same fields with `REPOST_2_` prefix
- Quote 1: `QUOTE_1_TEXT`, `QUOTE_1_ATTR`, `QUOTE_1_FB_CAPTION`, `QUOTE_1_HASHTAGS`
- Quote 2: same fields with `QUOTE_2_` prefix
- Notion page IDs returned by Step 6: `NOTION_MEME_1_ID`, `NOTION_MEME_2_ID`, `NOTION_QUOTE_1_ID`, `NOTION_QUOTE_2_ID`

```python
import urllib.request, json

preview_url = f"https://isabelhoppmann.github.io/ART-Lab-Social-Media/posts/{DATE}/"

blocks = [
    {
        "type": "header",
        "text": {"type": "plain_text", "text": f"\U0001f3a8 Zenie Content \u2014 Week of {DATE}"}
    },
    {
        "type": "section",
        "text": {"type": "mrkdwn", "text": f"This week's drafts are ready for review! <{preview_url}|\U0001f449 Preview all posts>\n\nReply in this thread with approvals or edit requests."}
    },
    {"type": "divider"},
    {
        "type": "section",
        "text": {"type": "mrkdwn", "text": f"*Meme 1* \u2014 _{MEME_1_OVERLAY_TEXT}_\n*IG:* {MEME_1_IG_CAPTION}\n*FB:* {MEME_1_FB_CAPTION}"}
    },
    {
        "type": "section",
        "text": {"type": "mrkdwn", "text": f"*Meme 2* \u2014 _{MEME_2_OVERLAY_TEXT}_\n*IG:* {MEME_2_IG_CAPTION}\n*FB:* {MEME_2_FB_CAPTION}"}
    },
    {
        "type": "section",
        "text": {"type": "mrkdwn", "text": f"*Repost 1* \u2014 @{REPOST_1_CREATOR}\n{REPOST_1_CAPTION}\n<{REPOST_1_URL}|View reel \u2197>"}
    },
    {
        "type": "section",
        "text": {"type": "mrkdwn", "text": f"*Repost 2* \u2014 @{REPOST_2_CREATOR}\n{REPOST_2_CAPTION}\n<{REPOST_2_URL}|View reel \u2197>"}
    },
    {
        "type": "section",
        "text": {"type": "mrkdwn", "text": f"*Quote 1* \u2014 \u201c{QUOTE_1_TEXT}\u201d \u2014 {QUOTE_1_ATTR}\n*FB:* {QUOTE_1_FB_CAPTION}"}
    },
    {
        "type": "section",
        "text": {"type": "mrkdwn", "text": f"*Quote 2* \u2014 \u201c{QUOTE_2_TEXT}\u201d \u2014 {QUOTE_2_ATTR}\n*FB:* {QUOTE_2_FB_CAPTION}"}
    },
    {"type": "divider"},
    {
        "type": "section",
        "text": {"type": "mrkdwn", "text": "*How to leave feedback (reply in this thread):*\n\u2022 `approved for meme 1` \u2014 keep it as-is\n\u2022 `change the overlay text on meme 2 to [new text]`\n\u2022 `change the background of quote 1`\n\u2022 `change the ig caption on meme 1 to [new text]`\n\u2022 `change the quote on quote 2 to [new quote] \u2014 [attribution]`"}
    }
]

payload = {
    "channel": SLACK_CHANNEL_ID,
    "text": f"Zenie content for week of {DATE} is ready for review!",
...
if not result.get("ok"):
    ...
    thread_ts = result["ts"]
    print(f"Slack message posted. Thread ts: {thread_ts}")
    ...
    state = {
        ...
        "posts": {
            "meme_1": {
                "label": "Meme 1",
                "notion_page_id": NOTION_MEME_1_ID,
                "overlay_text": MEME_1_OVERLAY_TEXT,
                "ig_caption": MEME_1_IG_CAPTION,
                "fb_caption": MEME_1_FB_CAPTION,
                "hashtags": MEME_1_HASHTAGS,
                "gif_url": MEME_1_GIF_URL,
                "giphy_embed_id": MEME_1_GIPHY_EMBED_ID,
                "approved": False
            },
            "meme_2": {
                "label": "Meme 2",
                "notion_page_id": NOTION_MEME_2_ID,
                "overlay_text": MEME_2_OVERLAY_TEXT,
                "ig_caption": MEME_2_IG_CAPTION,
                "fb_caption": MEME_2_FB_CAPTION,
                "hashtags": MEME_2_HASHTAGS,
                "gif_url": MEME_2_GIF_URL,
                "giphy_embed_id": MEME_2_GIPHY_EMBED_ID,
                "approved": False
            },
            "repost_1": {
                "label": "Repost 1",
                "url": REPOST_1_URL,
                "creator": REPOST_1_CREATOR,
                "ig_caption": REPOST_1_CAPTION,
                "approved": False
            },
            "repost_2": {
                "label": "Repost 2",
                "url": REPOST_2_URL,
                "creator": REPOST_2_CREATOR,
                "ig_caption": REPOST_2_CAPTION,
                "approved": False
            },
            "quote_1": {
                "label": "Quote 1",
                "notion_page_id": NOTION_QUOTE_1_ID,
                "quote": QUOTE_1_TEXT,
                "attribution": QUOTE_1_ATTR,
                "fb_caption": QUOTE_1_FB_CAPTION,
                "hashtags": QUOTE_1_HASHTAGS,
                "approved": False
            },
            "quote_2": {
                "label": "Quote 2",
                "notion_page_id": NOTION_QUOTE_2_ID,
                "quote": QUOTE_2_TEXT,
                "attribution": QUOTE_2_ATTR,
                "fb_caption": QUOTE_2_FB_CAPTION,
                "hashtags": QUOTE_2_HASHTAGS,
                "approved": False
            }
        },
    ...
    # Push state file using push_file() already defined in Step 3
    push_file(
        "social/review-state.json",
        json.dumps(state, indent=2).encode(),
        f"Save Slack review state for week of {DATE}"
    )
    print("Review state saved to GitHub.")
```
